...
TxRx.Ntx = 16;
TxRx.Nrx = 64;
TxRx.detector = 'AMP';  %'Limited_EP','EPD','Optimal_EP','AMP','LMMSE','GTA'
...
filename = [TxRx.detector,'_Normalized_',num2str(Ntx),'T',num2str(Nrx),'R_',num2str(2^TxRx.Modulation_order ),'QAM_',...
